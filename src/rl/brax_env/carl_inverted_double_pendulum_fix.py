"""
Modified version of https://github.com/automl/CARL/blob/main/carl/envs/brax/carl_inverted_double_pendulum.py
"""
...
class CARLBraxInvertedDoublePendulumFix(CARLBraxEnvFix):
